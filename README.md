...
0. Walls !
    ...
    * You don not need to be able to rotate the camera during the execution in this part, but you must provide a way to change the angle of the camera in your code to see if it works after recompiling it
...
6. Draw the map
    ...
    * You are free to draw the map where you want, with the color you want, …
